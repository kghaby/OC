...
local glasses_G=component.proxy("1a1ae323-1378-4fcb-9126-069cd2fccef8")
local glasses_Z=component.proxy("81fb32ee-5d34-4152-bb59-f1ff34a969cd")
local glasses_K=component.proxy("4c3ef641-a0df-4a72-bfa0-bc1489c4b785")
...
local function get_LSC_info(lsc)
    ...
    if sensorInformation ~= nil then
        ...
        local status = {
            ...
            EUIn =  parser.getInteger(parser.split(sensorInformation[7],"(")[1] or 0), --totEUIn,  --7 is avg. 5 in eu in
            EUOut = parser.getInteger(parser.split(sensorInformation[8],"(")[1] or 0),  --totEUOut,   --8 is avg. 6 in eu out
